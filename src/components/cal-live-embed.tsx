...
// Live Cal.com booking embed. Lazy-loaded by <CalEmbed/> ONLY when
// CAL_ENABLED is true, so the Cal script / getCalApi never runs while booking
// is disabled. TODO: replace the placeholder `sersan/scoping-call` slug with
// the real Sersan booking link when CAL_ENABLED is flipped on.
import { useEffect } from "react";
import Cal, { getCalApi } from "@calcom/embed-react";
import { useLanguage } from "@/components/language-provider";

interface CalLiveEmbedProps {
  slug?: string;
  theme?: "dark" | "light" | "auto";
  hideEventTypeDetails?: boolean;
}

export function CalLiveEmbed({
