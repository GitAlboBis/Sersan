...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    industry: "Agritech",
    summary:
      "Thirteen-business-line integrated operation across agriculture, hospitality and renewable energy in Sulcis Iglesiente, Sardinia. A SerSan engagement led from the board with Michele as President & CTO: digital architecture owned end-to-end, ~1.5 MWp of agrivoltaic capacity planned across tens of hectares, with IoT sensor networks, agrivoltaic monitoring, predictive-maintenance pipelines, thermographic and agricultural drone telemetry, and SCADA-adjacent integrations being implemented on a Databricks-centred stack. Focus on sustainable local biomass, energy autonomy, and circular-economy practices across the operating lines.",
    summaryIt:
      "Operazione integrata su tredici linee di business tra agricoltura, ospitalità ed energia rinnovabile nel Sulcis Iglesiente, in Sardegna. Engagement SerSan guidato dal consiglio con Michele come Presidente & CTO: architettura digitale end-to-end, ~1,5 MWp di capacità agrivoltaica pianificati su decine di ettari, con reti di sensori IoT, monitoring agrivoltaico, pipeline di manutenzione predittiva, telemetria da droni termografici e agricoli, e integrazioni SCADA-adjacent in implementazione su uno stack centrato su Databricks. Focus su biomassa locale sostenibile, autonomia energetica e pratiche di economia circolare lungo tutte le linee operative.",
    ...
    metrics: [
      ...
      { value: "In implementation", label: "IoT, predictive maintenance, drone telemetry and SCADA-adjacent systems being built on Databricks", labelIt: "IoT, manutenzione predittiva, telemetria droni e sistemi SCADA-adjacent in costruzione su Databricks" },
  ...
  },
  {
    ...
    status: "completed",
    engagement: "Fractional CTO · Industrial AI programme",
    engagementIt: "CTO frazionale · Programma AI Industriale",
    role: "Michele Sanna. Chief Technology Officer (contract, pre-SerSan)",
    roleIt: "Michele Sanna. Chief Technology Officer (contratto, pre-SerSan)",
